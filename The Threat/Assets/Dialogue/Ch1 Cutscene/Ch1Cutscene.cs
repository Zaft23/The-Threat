...
public class Ch1Cutscene : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialogTexts.Add(new DialogData("People who is being hunted by me also call me by those names.", "ZakiNoAvatar"));
        dialogTexts.Add(new DialogData("I’m a terror for those who ruined my live and everything that they did to me and this City. I’ll do everything and anything to have them judged by own hand and ways. ", "ZakiNoAvatar"));
