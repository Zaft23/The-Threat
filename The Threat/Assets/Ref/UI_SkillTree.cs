...
public class UI_SkillTree : MonoBehaviour {
    ...
    public void SetPlayerSkills(PlayerSkills playerSkills) {
        ...
        skillButtonList.Add(new SkillButton(transform.Find("IncreaseBase"), playerSkills, PlayerSkills.SkillType.IncreaseBase, skillLockedMaterial, skillUnlockableMaterial));
        skillButtonList.Add(new SkillButton(transform.Find("IncreaseHealth"), playerSkills, PlayerSkills.SkillType.IncreaseHealth, skillLockedMaterial, skillUnlockableMaterial));
